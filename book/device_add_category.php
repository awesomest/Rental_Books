   ...
   <div class="main">
    <div id="ui-tab">
      ...
      <div id="fragment-1">
        ...
        if(isset($_POST["new"])){
          $category = $_POST["new"];
          $res = mysql_query("SELECT * FROM DEVICE_CATEGORY WHERE DEVICE_CATEGORY.NAME = '$category'");
          ...
          if($value){
            ...
            $flag=mysql_query("INSERT INTO DEVICE_CATEGORY (NAME) VALUES ('$category')");
            if($flag){
              echo '<script type="text/javascript">';
        ...
        echo '</select></p>';
        ?>
        <FORM METHOD="post" ACTION="device_add_category.php#fragment-1"> 
          <input type="text" name="new">
          <input type="submit" value="カテゴリの追加">
          <p align="center"><a href="./device_add.php">デバイスの追加へ戻る</a></p>
        </div>
      </div>
      ...
      <div id="fragment-2">
        ...
        if(isset($_POST["del_category"])){
          ...
          $res = mysql_query("DELETE FROM DEVICE_CATEGORY WHERE DEVICE_CATEGORY.NAME = '$category'");
          $value = mysql_fetch_assoc($res);
          if($value){
            echo '<script type="text/javascript">';
            echo 'alert( "削除しました" )';
        ...
        echo '<FORM METHOD="post" ACTION="add_device_category.php#fragment-2">';
        echo '</select><input type="submit" value="カテゴリの削除"></p>';
        ?>
          <p align="center"><a href="./device_add.php">デバイスの追加に戻る</a></p>
        </form>
      </div>
    </div>
