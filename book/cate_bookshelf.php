   ...
   <div class="main">
    <div class = "searchForm">  
      <form class="s" method="get" action="<?php echo $_SERVER['PHP_SELF'] ?>">
        <input type="text" name="word" value="<?php echo $_GET["word"] ?>" style = "width: 300px;height:35px;">
          ...
          while($value=mysql_fetch_assoc($re)){
            ...
            if($num >0){
              ...
              while($value2=mysql_fetch_assoc($re2)){
                ...
                echo '<li class="cate">●<a href="./cate_bookshelf.php?word='.$value2[NAME].'">'.$value2[NAME].'</a></li>';
