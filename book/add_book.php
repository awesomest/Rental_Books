		...
		<div class ="sitebox">
			...
			<div class="main">
				<div id="ui-tab">
					...
					echo '<p><span id="tab1_text5">●カテゴリ</span><a href="./add_category.php">(追加)</a></p>';
					...
					//echo '<option value = '.$book_numberText.'>'.$book_numberText.'';
					echo '<option value = 未指定>未指定';
					echo '<option value = 実験実習費>実験実習費';
					echo '<option value = 個人研究費>個人研究費';
					echo '<option value = 研学研究費>研学研究費';
					echo '<option value = 情報研研究費>情報研研究費';
					echo '<option value = 谷私費>谷私費';
					echo '<option value = 卒業生寄付>卒業生寄付';
					echo '</select>';
